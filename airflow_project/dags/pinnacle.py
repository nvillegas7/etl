...
from tasks.extractor_api import extractor_api
...
with DAG(
    ...
    extractor = PythonOperator(
        task_id='extractor_api',
        python_callable=extractor_api,
    ...
    loader = PythonOperator(
        ...
        op_args=['{{ ti.xcom_pull(task_ids="extractor_api") }}']  # Pull parsed data from Parser task
    )
